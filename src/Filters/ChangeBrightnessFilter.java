...
public class ChangeBrightnessFilter {
  ...
  */
  ...
  public static BufferedImage BrightnessFilter(BufferedImage img, double scale){
   ...
   */
  public static void ScalePixel(int x, int y, double scale, BufferedImage img){
